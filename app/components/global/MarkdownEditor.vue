...
`,
  editorProps: {
    attributes: {
      class:
        'prose prose-invert max-w-none prose-p:my-1 focus:outline-none min-h-[500px] py-4 px-2 md:px-8',
...
<template>
  <div class="space-y-6 max-w-6xl mx-auto">
    <span aria-live="polite" class="sr">
      {{
        copied !== 'none'
          ? `Copied as ${copied === 'md' ? 'Markdown' : 'Rich Text'}`
          : ''
      }}
    </span>
